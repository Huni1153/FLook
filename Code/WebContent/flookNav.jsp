	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container" id="main_container">
			...
			<div class="navbar-header">
				...
				<a href="profile.jsp" id="main_kindof" class="sliding-middle-out"><span
					class="main_flook_recipe_btn"><c:if test="${sessionScope.userName != null}">${sessionScope.userName}</c:if></span></a>
				<input type="image" src="img/main_img/kwongiho.png"
