...
<div id="Write_container">
	<form id="Write_form" class="Write_form" method="post" action="writeRecipe"><!-- method action 추가 -->
		<div id="write_element1" class="write_element">
			<div id="write_name_scope">
				...
				<img alt="" id="write_photo" src="img/write_img/pic_none4.gif"  style="width: 210px; height: 210px; cursor:pointer" name="completeImage"onclick='document.all.file1.click(); document.all.completeImage.src=document.all.file1.value'> 
