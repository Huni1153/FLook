...
<body>
		...
		<div class="container-fluid">
			<div>
				<ul class="nav navbar-nav" id="profile_navbar-nav">
					<li class="profile_nav"><a href="graph.jsp">취향분석표</a></li>
					<li class="profile_nav"><a href="myWriteRecipe.jsp">내가 작성한 레시피</a></li>
					<li class="profile_nav"><a href="myScrap.jsp">MY스크랩</a></li>
					<li class="dropdown" id="profile_navMore"><a class="dropdown-toggle"
					...
					<li class="profile_nav"><a href="following.jsp">팔로윙</a></li>
					<li class="profile_nav"><a href="follower.jsp">팔로워</a></li>
				</ul>
			</div>
		</div>
		</nav>
	...
	<div class="modal fade" id="profileModifyModal" tabindex="-1"
		...
		<div class="modal-dialog" role="document" id="profile_profileModify_modal">
			<!-- modal content -->
