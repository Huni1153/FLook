...
public class SNSFriendViewVO implements Serializable{
	...
	public String toString() {
		return "SNSFriendViewVO [snsFriendCode=" + snsFriendCode
				+ ", userCode=" + userCode + ", friendUserCode="
				+ friendUserCode + ", friendUserName=" + friendUserName
				+ ", friendUserImage=" + friendUserImage
				+ ", friendUserBirthday=" + friendUserBirthday + "]";
	}
