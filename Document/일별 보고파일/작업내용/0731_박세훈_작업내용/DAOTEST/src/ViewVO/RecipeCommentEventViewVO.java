...
public class RecipeCommentEventViewVO {
	...
	public String toString() {
		return "RecipeCommentEventViewVO [commentUserCode=" + commentUserCode
				+ ", commnetCode=" + commnetCode + ", userCode=" + userCode
				+ ", recipeCode=" + recipeCode + ", postCode=" + postCode
				+ ", commentDate=" + commentDate + ", completeImage="
