...
<script src="css/main_css/assets/js/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="css/profile_css/cs.css"><!-- 알림벨 사용위해 -->
 <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script><!-- 부트스트랩 js파일(드롭박스)위해서 사용 -->
...
<header id="main_header" >
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="container" id="main_container">
                    ...
                    <div class="navbar-header">
                            <input type="image" src="css/main_css/assets/img/r2d2/logo.png"  class="logo" id="main_logo"onclick="location.href='main.jsp'">
							<a href="FlookRecipe.jsp" id="main_kindof" class="sliding-middle-out"><span class="main_flook_recipe_btn">Flook레시피</span></a>
							<a href="myRecipe.jsp" id="main_imcooker" class="sliding-middle-out"><span class="main_flook_recipe_btn">나도 요리사</span></a>
		...
		<a id="dLabel" data-target="#" data-toggle="dropdown"
			...
			<input type="image" src="img/main_img/bell.png" id="main_bell" class="main_header_icon"> <span class="caret"></span>
		</a>
		...
		<a id="dLabel" data-target="#" data-toggle="dropdown"
			aria-haspopup="true" role="button" aria-expanded="false">
			 <input type="image"
			src="img/main_img/ShoppingCart.png"id="main_shoppingCart" class="main_header_icon"> <span class="caret"></span>
		</a>
		...
		<ul id="viewCart_cart" class="dropdown-menu" role="menu"
			...
			<ul>
				...
				<li role="presentation">
					...
					<div class="viewCart_ingredient">
						<img class="viewCart_ingredient_img" src="img/viewCart_img/boochoo.png"">부추
						1줌 / 부추삼겹살
					</div>
					<div class="viewCart_marker_delete">
						<img class="viewCart_marker_img" src="img/viewCart_img/marker.png">
						<a href="#"><img class="viewCart_delete_img"
			...
			<ul >
				...
				<li role="presentation">
					...
					<div class="viewCart_ingredient"">
						<img class="viewCart_ingredient_img"
							src="http://www.njkoreabbq.com/wp-content/uploads/2014/03/sam.png">삼겹살 600g /
						부추삼겹살
					</div>
					<div class="viewCart_marker_delete">
						<img class="viewCart_marker_img" src="img/viewCart_img/marker.png"">
						<a href="#" ><img class="viewCart_delete_img"
							...
							<input type="image" src="img/main_img/Newspid.png" id="main_newspid" class="main_header_icon" onclick="location.href='newspeed.jsp'"/>
							<a href="" id="main_kindof" class="sliding-middle-out"><span class="main_flook_recipe_btn">음식파트너</span></a>
							<a href="profile.jsp" id="main_kindof" class="sliding-middle-out"><span class="main_flook_recipe_btn">김정윤</span></a>
							<input type="image" src="img/main_img/kwongiho.png" id="main_profile" class="main_header_icon"/>
                    </div>
                </div>
        </nav>
</header>
