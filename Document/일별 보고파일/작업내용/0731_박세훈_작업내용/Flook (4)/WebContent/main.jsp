...
<!-- <script type="javascript" src="https://maps.google.com/maps/api/js?v=3.exp&region=KR"></script> --><!-- googlemaps -->
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAE_LJbtqgkiZ04HJ3X00smAU_lnv0lZxw&sensor=true또는false"></script> --><!-- googlemaps -->
<!-- <script src="js/googleMaps.js" type="text/javascript" charset="UTF-8"> --></script><!-- googlemaps -->
<!-- test -->
...
<!-- <input type="button" id="tempMapBtn" value="현재위치 지도보기"> --><!-- 구글맵 -->
<!-- <div  id="tempMapScreen" ></div> --><!-- 구글맵 -->
