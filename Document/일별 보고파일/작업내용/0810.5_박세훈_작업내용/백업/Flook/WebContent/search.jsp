...
<!-- <link rel="stylesheet" type="text/css"
	href="css/myWriteRecipe_css/myWriteRecipe.css"> --><!-- 잠깐 지움. -->
    ...
    <div id="wrapper">
        ...
        <aside id="sideBar">
            <ul class="main-nav">
                ...
                <li class="nav-brand">
                    <a href="main.jsp"><img src="css/main_css/assets/img/r2d2/logo.png" alt="" id="search_logo"></a>
                </li>
                <!-- Search -->
			...
			<div id="search_one_recipeName" class="search_result_list">
				<c:forEach var="searchData" items="${simpleRecipeByName }">
					<div class="view view-first">
						...
						<div class="mask">
							<a type="button" href="javascript:detailSee('${searchData.recipeCode}')">${searchData.recipeName }</a>
			...
			<div id="search_two_recipeHashTag" class="search_result_list">
				<c:forEach var="searchData" items="${simpleRecipeByHashTag }">
					<div class="view view-first">
						<img src="${searchData.completeImage }" class="search_result_img"/>
						<div class="mask">
							<a button="button" href="javascript:detailSee('${searchData.recipeCode}')">${searchData.recipeName }</a>
							<p>${searchData.recipeDescription }</p>
							<jsp:include page="ratingFork.jsp"></jsp:include>					
						</div>
					</div> 
			...
			<div id="search_three_userRecipeName" class="search_result_list">
				<c:forEach var="searchData" items="${simpleUserRecipeByName }">
					<div class="view view-first">
						<img src="${searchData.completeImage }" class="search_result_img"/>
						<div class="mask">
							<h2><a href="javascript:detailSee('${searchData.recipeCode}')">${searchData.recipeName }</a></h2>
							<p>${searchData.recipeDescription }</p>
							<jsp:include page="ratingFork.jsp"></jsp:include>				
						</div>
					</div> 
			...
			<div id="search_five_userList" class="search_result_list">
				<c:forEach var="searchData" items="${UserList }">
					<div class="view view-first">
						<img src="${searchData.userImage }" class="search_result_img"/>
						<div class="mask">
