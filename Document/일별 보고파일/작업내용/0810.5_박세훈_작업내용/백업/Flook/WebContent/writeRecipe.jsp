								...
								.on(
										...
										function() {
											...
											$(mainIngredientTable)
													.find('li:last')
													.after(
															'<li><input type="text" placeholder="재료"  name="mainIngredient" required="required"/><input type="number" placeholder="수량"  name="mainIngredientAmount"required="required"/><select name="mainIngredientUnit"><option value="IUC001">g</option><option value="IUC002">ml</option><option value="IUC003">개</option><option value="IUC004">종이컵</option><option value="IUC005">숟가락</option><option value="IUC006">줌</option><option>직접입력</option></select><button class="write_modMainIngredientButton" onclick="deleteLine(this);">-</button></li>');
											//$(this).html('hi');
			...
			<div id="write_element1" class="write_element">
				<div id="write_name_scope">
					...
					<input type=file name='completeImage' style='display: none;'
						...
						name="complete" alt="" id="write_photo"
						src="img/write_img/pic_none4.gif"
			...
			<div id="write_element3" class="write_element">
				<div>
					<ul id="write_mainIngredient">
						...
						<li><input type="text" placeholder="재료" name="mainIngredient" required="required"/>
							<input type="number" placeholder="수량" name="mainIngredientAmount"required="required" />
				...
				<div>
					<ul id="write_subIngredient">
						...
						<li><input type="text" placeholder="재료" name="subIngredient" required="required"/>
							<input type="number" placeholder="수량" name="subIngredientAmount" required="required" />
