...
public class SimpleFlookRecipeViewDAO {
	...
	public LinkedList<SimpleRecipeViewVO> searchFlookRecipeList(String mehtod,String situation,String nation,String ingredient) {
		PreparedStatement pstmt = null;
		LinkedList<SimpleRecipeViewVO> list = new LinkedList<SimpleRecipeViewVO>();
		try {
			String sql = "select * from simple_recipe_view where recipe_code like ? and method_category_name=? and situation_category_name =? and country_category_name=? and ingredient_category_name=?";
