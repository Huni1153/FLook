...
public class FlookRecipeManager {
	...
	public LinkedList<SimpleRecipeViewVO> searchFlookRecipeList(String method,String situation,String nation,String ingredient) {
		return simpleFlookRecipeViewDAO.searchFlookRecipeList(method,situation,nation,ingredient);
	}
}
