...
public class RecipeDAO {
	...
	public String modifyRecipe(String recipeCode,String completeImage,String recipeName,String recipeDescription,int personNumber,String cookingTime,String cookingLevel)
	{
		...
		{
			// 완성사진 변경 불가
			String sql = "UPDATE recipe_tb SET recipe_name=?,recipe_description=?,person_number=?,cooking_time=?,cooking_level=? WHERE recipe_code=?";
			...
			pstmt.setString(2,recipeDescription);
			pstmt.setInt(3,personNumber);
			pstmt.setString(4,cookingTime);
			pstmt.setString(5,cookingLevel);
