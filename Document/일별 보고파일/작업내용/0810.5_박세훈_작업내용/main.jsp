...
<body>
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="img/main_img/banner/main.png" alt="..."
						class="main_banner">
		...
		<ol>
			<li class="main_li">
				<div id="main_today_recommend">
					<div id="main_today_recomment_title"
						class="main_today_recommend_div">
						<img src="img/main_img/body/recommend_title.png"
							id="main_today_recomment_title1" />
					</div>
					<div id="main_today_recomment_main"
						class="main_today_recommend_div">
						<img src="img/main_img/body/recommend_img1.png"
							id="main_today_recomment_image1" />
					</div>
					...
					<div id="main_today_recomment_sub" class="main_today_recommend_div">
						<%
							for (int i = 2; i < 6; i++) {
						%>
						<img src="img/main_img/recipe/recipe_0000<%=i%>.jpg"
							id="main_today_recomment_image<%=i%>" class="main_today_image" />
						<%
							}
						%>
			...
			<li class="main_li">
				<div id="main_feeling_recommend">
					<div id="main_feeling_recommend_title"
						class="main_feeling_recommend_div">
						<img src="img/main_img/body/fityourfeeling.png"
							id="main_feeling_recomment_image1"
							class="main_feeling_recommend_div" />
					</div>
					<input type="image" src="img/main_img/body/rightButton.png"
						id="main_rightButton" class="main_rightButton_">
					<div id="main_feeling_recomment_sub"
						class="main_feeling_recommend_div">
						<%
							for (int i = 0; i < 6; i++) {
						%><!--  -->
						...
						<div class="view view-first">
							<img src="img/main_img/recipe/recipe_0000<%=i%>.jpg"
								id="main_today_recomment_image2"
								class="main_seasonWeather_image" />
						</div>
						<%
							}
						%>
				...
				<div id="main_feeling_recommend_change">
					<%
						for (int i = 10; i < 18; i++) {
					%>
					<img src="img/main_img/recipe/recipe_000<%=i%>.jpg"
						id="main_today_recomment_image2" class="main_seasonWeather_image" />
					<%
						}
					%>
				</div>
			...
			<li class="main_li">
				<div id="main_situation_recommend">
					<div id="main_situation_recommend_title"
						class="main_situation_recommend_div">
						<img src="img/main_img/body/whatsituation.png"
							id="main_situation_recomment_image1"
							class="main_situation_recommend_div" />
					</div>
					<input type="image" src="img/main_img/body/rightButton.png"
						id="main_rightButton" class="main_rightButton_">
					...
					<div id="main_situation_recomment_sub"
						class="main_situation_recommend_div">
						<%
							for (int i = 0; i < 6; i++) {
						%>
			...
			<li class="main_li">
				<div id="main_seasonWeather_recommend">
					<div id="main_seasonWeather_recommend_title"
						class="main_seasonWeather_recommend_div">
						<img src="img/main_img/body/thisseasonorweather.png"
							id="main_seasonWeather_recomment_image1"
							class="main_seasonWeather_recommend_div" />
					</div>
					<input type="image" src="img/main_img/body/rightButton.png"
						id="main_rightButton" class="main_rightButton_">
					...
					<div id="main_seasonWeather_recomment_sub"
						class="main_seasonWeather_recommend_div">
						<%
							for (int i = 0; i < 6; i++) {
						%><!-- jstl로바껴야됨 -->
			...
			<li class="main_li">
				<div id="main_movie_recommend">
					<div id="main_movie_recommend_title"
						class="main_movie_recommend_div"></div>
					<div id="main_movie_recomment_main"
						class="main_movie_recommend_div"></div>
				</div>
			</li>
		</ol>
	...
	<button type="button" class="btn btn-primary btn-lg"
		data-toggle="modal" data-target="#myModal" id="tempBtn">
		Flook 요리사 레시피 조회</button>
				...
				<div class="modal-body">
					...
					<div id="recipe_see">
						...
						<div id="recipe_categori_see">
							<span id="recipe_kindof_see" class="recipe_categori">볶음</span> <span
								id="recipe_life_see" class="recipe_categori">일상</span> <span
								id="recipe_nation_see" class="recipe_categori">한식</span> <span
								id="recipe_meet_see" class="recipe_categori">육류</span>
						</div>
						...
						<div id="recipe_use_ingredient">
							<form method="get" action="">
								<h2 id="recipe_name_see">사용된 재료</h2>
								...
								<div id="recipe_main_ingredient">
									<h5>
										...
										<p>
											<input type="checkbox" name="recipe_ingredient">김치
											한포기
										</p>
										<p>
											<input type="checkbox" name="recipe_ingredient">쌀
											300g
										</p>
										<p>
											<input type="checkbox" name="recipe_ingredient">돼지고기
											100g
										</p>
								</div>
								<div id="recipe_sub_ingredient">
									<h5>부재료</h5>
									<p>
										<input type="checkbox" name="recipe_ingredient">소금1T
									</p>
								</div>
						...
						<div id="recipe_cooking_course">
							<!-- jstl나올자리 -->
							<div class="block">
								<img src="img/main_img/body/feeling_img1.png"
									class="recipe_cooking_course_img">
								<textarea class="recipe_cooking_course_infomation"></textarea>
							</div>
							<div class="block">
								<img src="img/main_img/body/feeling_img2.png"
									class="recipe_cooking_course_img">
								<textarea class="recipe_cooking_course_infomation"></textarea>
							</div>
							<div class="block">
								<img src="img/main_img/body/feeling_img3.png"
									class="recipe_cooking_course_img">
								<textarea class="recipe_cooking_course_infomation"></textarea>
							</div>
				...
				<div class="modal-body">
					...
					<div id="recipe_see">
						...
						<div id="recipe_name">
							...
							<input type="button" value="수정" id="recipe_modify_see"> <input
								type="button" value="삭제" id="recipe_delete_see"> <input
								type="image" src="img/main_img/Share.png"
								class="recipe_see_button" id="shareBtn"> <input
								type="image" src="img/main_img/heart_empty.png"
								class="recipe_see_button" id="heart_Btn"> <input
								type="image" src="img/main_img/Bookmark.png"
						...
						<div id="recipe_categori_see">
							<span id="recipe_nation_see" class="recipe_categori">${userUIBean.countryCategory }</span>
							<span id="recipe_life_see" class="recipe_categori">${userUIBean.ingredientCategory }</span>
							<span id="recipe_kindof_see" class="recipe_categori">${userUIBean.kindCategory }</span>
							<span id="recipe_meet_see" class="recipe_categori">${userUIBean.situationCategory }</span>
							<span class="recipe_categori">${userUIBean.methodCategory }</span>
	...
	<button type="button" class="btn btn-primary btn-lg"
		data-toggle="modal" data-target="#myModal3" id="tempBtn">동영상
		레시피 조회</button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div id="recipe_see">
						<div id="recipe_complete">
							<video width="450" height="320" controls> <source
								src="movie/BackTeacher_1.mp4" type="video/mp4"></video>
						</div>
						<div id="recipe_name">
							<h1 id="recipe_name_see">
								레시피명
								...
								<script type="text/javascript">
									...
									$("#heart_Btn")
											.click(
													function() {
														if ($("#heart_Btn")
																.attr("src") == "img/main_img/heart_empty.png") {
															$("#heart_Btn")
																	.attr(
																			"src",
																			"img/main_img/heart_fill.png");
														} else {
															$("#heart_Btn")
																	.attr(
																			"src",
																			"img/main_img/heart_empty.png")
														}
													});
									$("#bookmarkBtn")
											.click(
													function() {
														if ($("#bookmarkBtn")
																.attr("src") == "img/main_img/Bookmark.png") {
															$("#bookmarkBtn")
																	.attr(
																			"src",
																			"img/main_img/unBookmark.png");
														} else {
															$("#bookmarkBtn")
																	.attr(
																			"src",
																			"img/main_img/Bookmark.png");
														}
													});
								</script>
						</div>
