...
public class FollowViewVO implements Serializable{
	/**
	 * 
	 */
	...
	public FollowViewVO(String followCode, String userCode,
	...
	public String toString() {
		return "FollowViewVO [followCode=" + followCode + ", userCode="
				+ userCode + ", followUserCode=" + followUserCode
				+ ", followUserName=" + followUserName + ", followUserImage="
				+ followUserImage + "]";
	}
